...
- 星象层可切换：**西象**（IAU 88 星座示意）· **古象**（陈卓体系全表量级示意，含三垣·二十八宿·北斗及展开星官）
- 古象模式下可**题名**或**隐名**，减轻标签遮挡
- 星空背景含星场、星云、小行星带、彗星等装饰层

### 地面观星

- 顶栏可切换**轨道** / **地面**视角；地面视角从地表仰望星空，天球按当地恒星时旋转
- 观测位置支持**预设城市**（北京 · 上海 · 广州 · 成都 · 西安 · 拉萨 · 郑州 · 苏州）、**自定义经纬度**与**当前位置**（浏览器定位）
- 天球随纬度倾转：北天极指向北方地平线上方纬度高处，更换城市即可看到不同的星空
- 屏幕底部**方位罗盘 HUD** 实时显示当前所对方向（方位角）与仰角，仰视天顶时显示「天顶」
- **时间加速播放**：播放 / 暂停 + 速度档位（1 天/秒 · 7 天/秒 · 30 天/秒 · 一年/秒），可静观一年星宿的移动
...
- 主页三维场景切换至**古象**星象层后，点击星官名称标签，弹出「星官故事」卡片
...
- 顶栏**列宿**进入独立认星页：左侧为古象星空示意，右侧为《步天歌》歌诀节录与现代注释
- 滚动或点选歌诀时，星空高亮对应星官；歌诀中的星官名亦可打开星官故事卡片
- 支持题名 / 隐名切换，减轻标签遮挡

### 羲和

- 顶栏**羲和**进入天文史浏览页，纵览自西汉《太初历》至明清改历的关键人物
- 时间轴按年代排列，点击节点展开人物生平、主要成就与相关历法
- 可与列宿、主页历象对照，了解观象授时的历史脉络

## 操作摘要

| 平台 | 三维 | 换日 | 星象 / 历象 |
| --- | --- | --- | --- |
| **桌面** | 左键旋转 · 右键/中键平移 · 滚轮缩放 · Shift + 左键横拖拨日 | 顶栏选日期 · `←`/`→`（Shift ±30 日） | 顶栏切星象层 · 古象可题名/隐名 · 右侧历象可收起 |
| **触屏** | 单指旋转 · 双指缩放平移 · 长按后横拖拨日 | 顶栏 ‹ › · 日期选择器 | 顶栏切星象层 · 侧栏「历象」展开/收起 |

> 地面视角：左键 / 单指环视天空，屏幕底部罗盘指示所对方向与仰角；顶栏可播放 / 暂停时间加速并切换速度档位。
...
- **地面观星**：天球按当地恒星时（含时刻）与观测纬度倾转；方位角 / 高度由标准时角公式换算，教学近似，非精密星历。
